...
class Scaling {
 ...
 public:
  ...
  // TODO returns an expression
  friend inline LinearMatrixType operator*(const LinearMatrixType& other,
                                           const Scaling& s) {
  ...
  inline typename internal::cast_return_type<Scaling,
                                             Scaling<NewScalarType, Dim> >::type
  cast() const {
    return typename internal::cast_return_type<
        Scaling, Scaling<NewScalarType, Dim> >::type(*this);
  }
...
inline typename Scaling<Scalar, Dim>::TransformType Scaling<Scalar, Dim>::
