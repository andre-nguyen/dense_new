...
/** \geometry_module \ingroup Geometry_Module
  ...
  *representations
  * like Euler angles or 3x3 matrices, quatertions offer the following
  *advantages:
...
class Quaternion : public RotationBase<Quaternion<_Scalar>, 3> {
 ...
 public:
  ...
  Quaternion& setFromTwoVectors(const MatrixBase<Derived1>& a,
  ...
  cast() const {
    return typename internal::cast_return_type<
        Quaternion, Quaternion<NewScalarType> >::type(*this);
  }
 ...
 * product */
template <typename Scalar>
inline Quaternion<Scalar> Quaternion<Scalar>::operator*(
...
/** Sets *this to be a quaternion representing a rotation sending the vector \a
  *a to the vector \a b.
  *
...
/** \returns the angle (in radian) between two rotations
  ...
  */
template <typename Scalar>
inline Scalar Quaternion<Scalar>::angularDistance(
    const Quaternion& other) const {
